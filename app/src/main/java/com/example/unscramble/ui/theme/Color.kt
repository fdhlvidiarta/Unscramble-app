...
val md_theme_dark_primary = Color(0xFF59658a) //Button submit dan navigasi bar
val md_theme_dark_onPrimary = Color(0xFFedede5) //color submit
...
val md_theme_dark_onBackground = Color(0xFFE4E1E6) //Judul
val md_theme_dark_surface = Color(0xFF060606) //Latar belakang
val md_theme_dark_onSurface = Color(0xFFE4E1E6)
val md_theme_dark_surfaceVariant = Color(0xFF222c3f) //Shape
val md_theme_dark_onSurfaceVariant = Color(0xFFC7C5D0)
val md_theme_dark_outline = Color(0xFF9ba5df) //Border btn skip
...
val md_theme_dark_surfaceTint = Color(0xFF59658a) //Shape skor
